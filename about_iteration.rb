...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # is just reduce the array to a single value, the first parameter is the initial value
  end
  ...
  # because the first one is more efficient, the second one will open the file and will not close it

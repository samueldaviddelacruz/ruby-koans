...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    # why nil? because the string doesn't start with "end"
  end
  ...
  # Answer: Character class matches one of the characters inside the brackets. 
  # Alternation matches one of the patterns on either side of the pipe.
